const de = {
  translation: {
    ...
    footerText:
      "BudDash ist eine Open-Source-Liefermanagementplattform für Zukunft. Wir legen Wert auf Innovation, Flexibilität und Erschwinglichkeit. und bieten Sie eine skalierbare, anpassbare Lösung, die Ihre Prozesse optimiert Lieferprozesse.",
    footerLinkHome: "Startseite",
    footerLinkPP: "Datenschutzbestimmungen",
    footerLinkTC: "Geschäftsbedingungen",
    footerEndText: "BudDash - © 2022 Alle Rechte vorbehalten",
    followUs: "Folge uns",
    ...
    createAccount: "Erstelle dein BudDash-Konto",
