          ...
          <Grid container item xs={10} sm={10} md={9}>
            <ol className={classes.boldText}>
              ...
              <li>
                ...
                <Typography variant="subtitle2">
                  BudDash reserves the right to change or modify these Terms (including our policies which are
              ...
              <li>
                ...
                <Typography variant="subtitle2">
                  ...
                  Platforms. BudDash reserves the right to investigate and take appropriate legal action against anyone
              ...
              <li>
                ...
                <Typography variant="subtitle2" className={classes.MV3}>
                  ...
                  any other website not approved by us is strictly prohibited. BudDash will aggressively enforce its
                  intellectual property rights to the fullest extent of the law, including criminal prosecution. BudDash
              ...
              <li>
                ...
                <ul className={classes.bullet}>
                  ...
                  <li>
                    ...
                    <Typography variant="subtitle2" className={classes.MV2}>
                      To purchase Alcohol, you must be of the statutory legal age. BudDash, the Vendor and their
                  ...
                  <li>
                    <Typography variant="subtitle2">
                      To purchase Tobacco, you must be of the statutory legal age. BudDash, the Vendor and their
                      delivery riders, as the case may be, reserve the right in their sole discretion:
                    </Typography>
              ...
              <li>
                ...
                <ul className={classes.bullet}>
                  ...
                  <li>
                    <Typography variant="subtitle2">
                      BudDash reserves the right to cancel any Order and/or suspend, deactivate or terminate your
              ...
              <li>
                ...
                <ul className={classes.bullet}>
                  ...
                  <li>
                    ...
                    <Typography variant="subtitle2" className={classes.MV2}>
                      BudDash reserves the right to offer additional payment methods and/or remove existing payment
                      ...
                      provider(s) for future orders. BudDash does not store your credit card or payment information.
                    </Typography>
                  </li>
                  <li>
                    <Typography variant="subtitle2">
              ...
              <li>
                ...
                <ul className={classes.bullet}>
                  ...
                  <li>
                    <Typography variant="subtitle2">
                      BudDash shall deliver your Order to the delivery address provided by You. You may choose for your
                  ...
                  <li>
                    ...
                    <Typography variant="subtitle2" className={classes.MV2}>
                      ...
                      event of issues or delays in your delivery. BudDash shall not be responsible in any way for Orders
              ...
              <li>
                ...
                <ul className={classes.bullet}>
                  ...
                  <li>
                    <Typography variant="subtitle2">
                      BudDash reserves the right to void, discontinue or reject the use of any Voucher without prior
              ...
              <li>
                ...
                <ul className={classes.bullet}>
                  ...
                  <li>
                    ...
                    <Typography variant="subtitle2" className={classes.MV2}>
                      BudDash shall neither be liable for actions or omissions of the Vendor nor you in regard to
                      provision of the Goods and where Vendor Delivery applies to your Order. BudDash does not assume
              ...
              <li>
                ...
                <Typography variant="subtitle2" className={classes.MV3}>
                  ...
                  Delivery, Vendors are responsible for delivery of the Goods and/or Orders. BudDash shall not be liable
              ...
              <li>
                ...
                <Typography variant="subtitle2" className={classes.MV3}>
                  ...
                  agree to do so at your own risk. BudDash does not control or endorse these third party websites or
                  links and shall not be responsible for the content of these linked pages. BudDash accepts no liability
              ...
              <li>
                ...
                <Typography variant="subtitle2" className={classes.MV3}>
                  BudDash has the right to terminate, suspend or delete your account and access to the Platforms,
                  ...
                  the event of any breach by you of the Terms. BudDash may, but shall be under no obligation to, provide
              ...
              <li>
                ...
                <Typography variant="subtitle2" className={classes.MV3}>
                  BudDash may amend these Terms at any time in its sole discretion. The amended Terms shall be effective
