const en = {
  translation: {
    ...
    saveButton: "Save",
    footerText:
      "BudDash is an open-source delivery management platform for the future. We prioritize innovation, flexibility, and affordability, and offer a scalable, customizable solution that streamlines your delivery processes.",
    footerLinkHome: "Home",
    footerLinkPP: "Privacy Policy",
    footerLinkTC: "Terms and Conditions",
    footerEndText: "BudDash – © 2022 All Rights Reserved",
    followUs: "Follow Us",
    ...
    delivery: "Delivery",
    searchRestaurantPlaceholder: "Search dispensaries and products",
    allRestaurant: "All Dispensaries",
    pending: "PENDING",
    accepted: "ACCEPTED",
    assigned: "ASSIGNED",
    picked: "PICKED",
    ...
    findRestaurants: "Find Dispensaries",
    putUsInYourPocket: "Put us in your pocket",
    containerText:
      "It's all at your fingertips -- the dispensaries you love. Find the right strain to suit your mood, delivered fast. Go ahead, download us.",
    ...
    createAccount: "Create your BudDash Account",
